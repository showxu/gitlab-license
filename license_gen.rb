...
# Required.
license.starts_at         = Date.today # .new(2021, 4, 26)
# The date the license expires. 
# Not required, to allow lifetime licenses.
license.expires_at        = Date.new(2077, 4, 26)
...
File.open("#{company}.gitlab-license", "w") { |f| f.write(data) }
...
data = File.read("#{company}.gitlab-license")
...
if $license.restricted?(:active_user_count)
  active_user_count = 1 # User.active.count
